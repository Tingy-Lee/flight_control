...
#define FC_IMU_UART_STALE_TIMEOUT_MS    50U
...
#define FC_RC_CHANNEL_HOVER_HEIGHT      2U
#define FC_RC_CHANNEL_YAW               3U
#define FC_RC_CHANNEL_THROTTLE          4U
/* CH7 is a two-position switch on FS-i6X/iA10B. FlySky iBUS channel numbers
 * are 0-based here, so CH7 maps to index 6. The lower switch position is the
 * armed/on position and is expected to read above the threshold.
 */
#define FC_RC_CHANNEL_ARM               6U
#define FC_RC_ARM_THRESHOLD_US          1600U
#define FC_ARM_THROTTLE_MAX_US          (FC_MOTOR_PWM_MIN_US + 30U)

/* RC decision mapping. Roll/pitch are attitude targets; CH3 is interpreted as
 * a hover-height change rate and integrated into a bounded height delta; CH4
 * is a body-axis yaw angular-rate target; CH5 is the throttle input used for
 * arming checks and takeoff trigger logic.
 */
